...
fileprivate class JSMatrixDataSource{
    ...
    static func getBrightnessAttributes(brightness: CGFloat) -> [NSAttributedStringKey : Any]{
        return [NSAttributedStringKey.foregroundColor: UIColor.init(hue: 127.0/360.0, saturation: 97.0/100.0, brightness: brightness, alpha: 1.0),
                NSAttributedStringKey.font: UIFont(name: "Matrix Code NFI", size: 17)!,
